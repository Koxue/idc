...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir('.' . DS . SWAP_TEMPLATES_ROOT . DS)
            ->setCompileDir(SWAP_TEMPLATES_C)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir(SWAP_CACHE)
            ->setConfigDir(SWAP_CONFIGS);
...
class SmartyException extends Exception
{
    ...
    {
        return ' --> SWAPMAC: ' . (self::$escape ? htmlentities($this->message) : $this->message)  . ' <-- ';
    }
}
