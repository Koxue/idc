$(document).ready(function() {
	...
	var o = function() {
		...
		s.hasClass("page-sidebar-fixed") ? e = a.height() + i: (e = a.height() + i, e < $(window).height() && (e = $(window).height())),
		e >= n.height() && n.attr("style", "min-height:" + e + "px !important")
	};
	o(),
	window.onresize = o,
	...
	m = function() {
		...
		$(".navbar .logo-box a span").html($(".navbar .logo-box a span").text() == u ? h: u),
		o()
	},
	b = function() {
		$("body").hasClass("page-horizontal-bar") && $("body").hasClass("page-sidebar-fixed") && $("body").hasClass("page-header-fixed") && (c.click(), alert("Static header isn't compatible with fixed horizontal nav mode. Modern will set static mode on horizontal nav.")),
		$("body").toggleClass("page-header-fixed"),
		o()
	},
	p = function() { ! $("body").hasClass("page-horizontal-bar") || $("body").hasClass("page-sidebar-fixed") || $("body").hasClass("page-header-fixed") || (t.click(), alert("Fixed horizontal nav isn't compatible with static header mode. Modern will set fixed mode on header.")),
		$("body").hasClass("hover-menu") && !$("body").hasClass("page-sidebar-fixed") && (hoverMenuCheck.click(), alert("Fixed sidebar isn't compatible with hover menu mode. Modern will set accordion mode on menu.")),
