{include file="client_header.tpl" title=$lang['帮助中心'] hostname=$c['网站名称']}
...
<div class="page-title">{$lang['帮助中心']}</div></div>
...
<a href="#">{$lang['帮助中心']}</a>&nbsp;&nbsp;
<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
<li class="active">{$lang['帮助中心']}</li></ol>
