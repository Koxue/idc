...
<form class="form-horizontal" method="post">
          <div class="form-group">
            <label for="name" class="col-sm-3 control-label">{$lang['姓名']}</label>
            <div class="col-sm-9 controls">
              <input name="name" type="text" value="{$s['登陆姓名']}" class="form-control"/>
            </div>
          </div>
          <div class="form-group">
            <label for="country" class="col-sm-3 control-label">{$lang['国家']}</label>
            <div class="col-sm-9 controls">
...
{/foreach}
          ...
          <div class="form-group">
            <label for="address" class="col-sm-3 control-label">{$lang['地址']}</label>
            <div class="col-sm-9 controls">
              <input name="address" type="text" value="{$s['登陆地址']}" class="form-control"/>
            </div>
          </div>
          <div class="form-group">
            <label for="zip" class="col-sm-3 control-label">{$lang['邮编']}</label>
            <div class="col-sm-9 controls">
              <input name="zip" type="text" value="{$s['登陆邮编']}" class="form-control"/>
            </div>
          </div>
          <div class="form-group mbn"> 
		  <label class="col-sm-3 control-label"></label>
            <div class="col-sm-9 controls"><button class="btn btn-success"><i class="fa fa-save"></i> {$lang['修改个人信息']}</button></div>
          </div>
	   </form>
