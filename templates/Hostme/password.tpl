{include file="cframe.tpl" title=$lang['用户中心'] hostname=$c['网站名称'] subtitle=$lang['用户中心']}
...
<div id="tab-profile-setting" class="tab-pane fade in active">
	   ...
	   <form class="form-horizontal" method="post">
			<div class="form-group">
				<label class="col-sm-3 control-label" for="inputPassword">{$lang['密码']} </label>
				<div class="col-sm-9 controls">
					<input name="password" type="password" data-required="true" placeholder="Password" id="inputPassword" class="form-control"/>
					<span class="help-inline">{$lang['输入您的密码']}</span>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label" for="inputNewpass">{$lang['新密码']} </label>
				<div class="col-sm-9 controls">
					<input name="newpassword" type="password" data-required="true" placeholder="New Password" id="inputNewpass" class="form-control"/>
					<span class="help-inline">{$lang['输入您的新密码']}</span>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label" for="inputRenewpass">{$lang['重复新密码']} </label>
				<div class="col-sm-9 controls">
					<input name="renewpassword" type="password" data-required="true" placeholder="Confirm New Password" id="inputRenewpass" class="form-control"/>
			...
			<div class="form-group mbn">
				...
				<label class="col-sm-3 control-label"></label>
					<button type="submit" data-loading-text="{$lang['修改中...']}" class="btn btn-success"><i class="fa fa-save"></i> {$lang['修改']}</button>
				</div>
			</div>
		</form>
