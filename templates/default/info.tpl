	...
	<h4 class="header">{$lang['用户中心']}</h4>{include file="alert.tpl"}
	   <form class="form-horizontal" method="post">
          <div class="control-group">
            ...
            <div class="controls">
              <input name="name" type="text" value="{$s['登陆姓名']}"/>
            </div>
          </div>
          <div class="control-group">
...
{/foreach}
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input name="address" type="text" value="{$s['登陆地址']}"/>
            </div>
          </div>
          <div class="control-group">
            <label for="zip" class="control-label">{$lang['邮编']}</label>
            <div class="controls">
              <input name="zip" type="text" value="{$s['登陆邮编']}"/>
            </div>
          </div>
          <div class="control-group"> 
            <div class="controls"><button class="btn">{$lang['修改个人信息']}</button></div>
          </div>
	   </form>
	</div>
    <div class="span3">
